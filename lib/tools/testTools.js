...
// TODO: write tests
var testToSaveResults = exports.testToSaveResults = function testToSaveResults(includeVersion) {
  return function (saveResults, test) {
    return (0, _assoc2.default)(includeVersion ? test.id + '_' + test.version : test.id, getTestSaveResult(test), saveResults);
  };
};

// TODO: write tests
var testsToSaveResults = exports.testsToSaveResults = function testsToSaveResults(tests, includeVersion) {
  return (0, _reduce2.default)(testToSaveResults(includeVersion), {}, (0, _values2.default)(tests));
};