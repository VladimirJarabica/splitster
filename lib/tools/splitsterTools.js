...
exports.getUserGroupsFromConfig = exports.getTestsFromConfig = exports.getNormalTests = exports.parseTestVersionKey = exports.disableByUsage = exports.disableBySeparateTests = exports.getSeparateRunTestId = exports.disableByUserGroupsExclude = exports.disableByUserGroups = exports.passTestUserGroups = exports.disableByDef = exports.checkDisabled = exports.disableByDeadline = exports.disableTestByDeadline = exports.disableByConfig = exports.disableByDev = exports.testDefProperlySet = exports.createTestsOpts = exports.mergeDefaultConfig = exports.mergeDefaultTests = exports.parseDef = undefined;
...
var parseDef = exports.parseDef = function parseDef(tests, def) {
  return (0, _compose2.default)((0, _reduce2.default)(function (acc, testId) {
    // Def might be specified with version or without
    var testDef = def[testId + '_' + (tests[testId].version || 0)] || def[testId];
    if (testDef) {
      return (0, _assoc2.default)(testId, testDef, acc);
    }
    return acc;
  }, {}), _keys2.default)(tests);
};
...
var testDefProperlySet = exports.testDefProperlySet = function testDefProperlySet(testId, version, def) {
  return (0, _has2.default)(testId, def) && def[testId] !== '__disabled_config' && def[testId] !== '__disabled_null';
};
...
var disableByConfig = exports.disableByConfig = function disableByConfig(tests) {
  return (0, _mapObjIndexed2.default)(function (test) {
...
var checkDisabled = exports.checkDisabled = function checkDisabled(def) {
  ...
  var reasons = ['usage', 'separate_test', 'user_group', 'user_group_exclude', 'deadline', 'dev'];
...
var disableByUserGroupsExclude = exports.disableByUserGroupsExclude = function disableByUserGroupsExclude(userGroups, user) {
  var def = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return function (tests) {
    if (!user || (0, _isEmpty2.default)(user)) {
      return tests;
    ...
    return (0, _mapObjIndexed2.default)(function (test, testId) {
      if (testDefProperlySet(testId, test.version || 0, def) || test.disabled || (0, _isEmpty2.default)(test.userGroupExclude)) {
        return test;
      }
      var disabledByUserGroupsExclude = passTestUserGroups(test.userGroupExclude, userGroups || {}, user || {});
      return (0, _compose2.default)((0, _assoc2.default)('disabledReason', disabledByUserGroupsExclude ? 'user_group_exclude' : null), (0, _assoc2.default)('disabled', disabledByUserGroupsExclude))(test);
    }, tests);
  };
};
...
var disableBySeparateTests = exports.disableBySeparateTests = function disableBySeparateTests(_ref) {
  ...
  return function () {
    ...
    return (0, _mapObjIndexed2.default)(function (test, testId) {
      if (testDefProperlySet(testId, test.version || 0, def) || test.disabled || testId === separateRunTestId) {
        return test;
      }
      return (0, _merge2.default)(test, {
...
var disableByUsage = exports.disableByUsage = function disableByUsage() {
  ...
  return function (tests, testRandom) {
    return (0, _mapObjIndexed2.default)(function (test, testId) {
      if (testDefProperlySet(testId, test.version || 0, def) || test.disabled || (0, _isNil2.default)(test.usage)) {
        return test;
      }
...
var parseTestVersionKey = exports.parseTestVersionKey = function parseTestVersionKey(key, config) {
  var arr = key.split('_');
  var last = (0, _last2.default)(arr);
  if (!isNaN(last)) {
    var _key$split = key.split(/(_)(?!.*_)/),
        _key$split2 = _slicedToArray(_key$split, 3),
        _testId = _key$split2[0],
        _ = _key$split2[1],
        _version = _key$split2[2];

    return { testId: _testId, version: Number(_version) };
  }
  return {
    testId: key,
    version: (0, _pathOr2.default)(0, ['tests', key, 'version'], config)
  };
};
...
var getTestsFromConfig = exports.getTestsFromConfig = function getTestsFromConfig() {
  ...
  disableByDeadline, disableByConfig, // set disabled by default or config
  disableByDef(def), disableByDev(def), mergeDefaultTests)(tests);
};
