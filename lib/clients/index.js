...
var _abTest = require("../records/abTest");
...
exports.SplitsterClient = function SplitsterClient(_ref, copy) {
  ...
  this.getSaveResults = function () {
    ...
    var noDisabled = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return (0, _compose3.default)(_fromPairs3.default, (0, _map3.default)(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2),
          testId = _ref3[0],
          test = _ref3[1];

      var winning = test.disabled ? noDisabled ? test.defaultVariant : "__disabled_" + test.disabledReason : test.winningVariant;
  ...
  this.tests = (0, _abTest.getTestsFromConfig)(config.tests, { override: override, user: user, userId: userId });
};
