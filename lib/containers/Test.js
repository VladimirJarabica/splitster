...
var constructTest = exports.constructTest = function constructTest(id, config) {
  ...
  var _parseWinningVariant = (0, _testTools.parseWinningVariant)(winningVariant, config),
      disabled = _parseWinningVariant.disabled,
      disabledReason = _parseWinningVariant.disabledReason;
  ...
  return {
    ...
    winningVariant: !disabled && winningVariant ? variants[winningVariant] : null,
