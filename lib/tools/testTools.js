...
exports.parseWinningVariant = exports.DisabledReasons = exports.testsToSaveResults = exports.testToSaveResults = exports.getTestSaveResult = exports.getWinningVariant = exports.runTracks = exports.getTracks = exports.getTrack = exports.getDefaultVariant = exports.getVariants = exports.getVariant = undefined;
...
var testToSaveResults = exports.testToSaveResults = function testToSaveResults(saveResults, test) {
  return (0, _assoc2.default)(test.id, getTestSaveResult(test), saveResults);
};
...
var DisabledReasons = exports.DisabledReasons = ['__disabled_usage', '__disabled_separate_test', '__disabled_user_group', '__disabled_config'];
var parseWinningVariant = exports.parseWinningVariant = function parseWinningVariant(winningVariant, config) {
  if (winningVariant && (0, _contains2.default)(winningVariant, DisabledReasons)) {
    console.log("parse winning variant");
    return {
      disabled: true,
      disabledReason: (0, _slice2.default)(11, Infinity, winningVariant)
    };
  }
  return {
