...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getSaveResults = function () {
    ...
    return (0, _testTools.testsToSaveResults)(_this.state.tests, includeVersion);
  };
  ...
  this.set = function (testId, variantId, cookies) {
    ...
    if (cookies) {
      ...
      _jsCookie2.default.set(cookieKey, variantId, (0, _pathOr2.default)(SplitsterFn.defaultOptions, ['options', 'cookies', 'cookiesOptions'], _this.state));
    }
