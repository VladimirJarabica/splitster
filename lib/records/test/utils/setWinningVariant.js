...
var setWinningVariant = function setWinningVariant(userId, testSeed) {
  return function (_ref5) {
    ...
    var seedNumber = (0, _isNil2.default)(testSeed) ? getSeedNumber(testId + "_" + test.version + ":" + userId) : testSeed;
