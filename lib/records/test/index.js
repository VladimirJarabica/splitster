...
var getTestFromConfig = exports.getTestFromConfig = function getTestFromConfig(_ref) {
  var override = _ref.override,
      user = _ref.user,
      userId = _ref.userId;
  return (0, _compose3.default)((0, _setWinningVariant2.default)(userId, { override: override }), (0, _disableByUsage2.default)(override), (0, _disableByUserGroups2.default)(user, override, true), // user group exclude
