...
exports.getUserGroupsFromConfig = exports.getTestsFromConfig = exports.getNormalTests = exports.parseTestVersionKey = exports.getDefaultByTestVersion = exports.disableByUsage = exports.disableBySeparateTests = exports.getSeparateRunTestId = exports.disableByUserGroups = exports.passTestUserGroups = exports.disableByDef = exports.checkDisabled = exports.disableByDeadline = exports.disableTestByDeadline = exports.disableByConfig = exports.disableByDev = exports.testDefProperlySet = exports.parseTestKey = exports.createTestsOpts = exports.mergeDefaultConfig = exports.mergeDefaultTests = undefined;
...
var parseTestKey = exports.parseTestKey = function parseTestKey(key) {
  var arr = key.split('_');
  ...
  if (!isNaN(last)) {
    ...
    console.log('key', key, 'has version specified', _version);
...
var checkDisabled = exports.checkDisabled = function checkDisabled(def) {
  ...
  var reasons = ['usage', 'separate_test', 'user_group', 'deadline', 'dev'];
...
var getDefaultByTestVersion = exports.getDefaultByTestVersion = function getDefaultByTestVersion(def, key, version) {
  return def[key + '_' + version] || def[key];
};
...
var parseTestVersionKey = exports.parseTestVersionKey = function parseTestVersionKey(key, config) {
  ...
  var last = (0, _last2.default)(arr);
  if (!isNaN(last)) {
    var _key$split3 = key.split(/(_)(?!.*_)/),
        _key$split4 = _slicedToArray(_key$split3, 3),
        _testId2 = _key$split4[0],
        _ = _key$split4[1],
        _version2 = _key$split4[2];

    return { testId: _testId2, version: Number(_version2) };
  }
  return {
    testId: key,
...
var getNormalTests = exports.getNormalTests = function getNormalTests(_ref2) {
  ...
  return function () {
    ...
    return (0, _reduce2.default)(function (acc, key) {
      return (0, _assoc2.default)(key, (0, _Test.constructTest)(key, tests[key], tracks, createTestsOpts(getDefaultByTestVersion(def, key, tests[key].version))), acc);
...
var getTestsFromConfig = exports.getTestsFromConfig = function getTestsFromConfig() {
  ...
  var res = (0, _compose2.default)(getNormalTests(opts), // construct tests
